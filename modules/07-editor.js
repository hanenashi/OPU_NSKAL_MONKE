window.Editor = {
    getEditorHTML: () => `
        ...
        <head>
            ...
            <style>
                body { font-family: sans-serif; margin:0; display:flex; height:100vh; background:#1a1a1a; color:#ccc; overflow:hidden; }
                .sidebar { width:280px; background:#252526; border-right:1px solid #333; display:flex; flex-direction:column; }
                .sidebar-content { flex:1; overflow-y:auto; padding:10px; }
                .file-item { background:#333; padding:10px; margin-bottom:8px; border-radius:4px; cursor:move; border:1px solid transparent; }
                .file-item.active { border-left:4px solid #007acc; background:#3d3d3d; }
                .file-meta { font-size:10px; color:#888; margin-top:4px; }
                .main-area { flex:1; display:flex; flex-direction:column; background:#111; }
                .btn { padding:8px 12px; border:none; border-radius:4px; cursor:pointer; color:white; background:#444; }
        ...
        <body>
            ...
            <div class="main-area">
                ...
                <div style="height:60px; background:#2d2d2d; display:flex; align-items:center; justify-content:center; gap:10px">
                    <button class="btn" onclick="cropper.rotate(90)">↻ Rotate</button>
