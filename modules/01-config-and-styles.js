...
window.STYLES = `
    .nskal-button { padding: 2px 10px; font-size: 11px; cursor: pointer; margin-right: 5px; border: 1px solid #ccc; background-color: #f0f0f0; border-radius: 3px; font-weight: bold; color: #333; }
    ...
    .nskal-settings-modal { background: #ffd5a9; padding: 20px; border-radius: 12px; width: 90%; max-width: 500px; color: #333; border: 2px solid #e69138; box-shadow: 0 4px 15px rgba(0,0,0,0.3); }
    .settings-row { display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }
    .nskal-input { padding: 4px; border: 1px solid #c0a080; border-radius: 4px; background: #fff; }
    .nskal-toggle-btn { padding: 4px 10px; border: 1px solid #c0a080; background: #fdfdfd; cursor: pointer; border-radius: 4px; font-size: 11px; }
    .nskal-toggle-btn.active { background: #e69138; color: white; }
`;